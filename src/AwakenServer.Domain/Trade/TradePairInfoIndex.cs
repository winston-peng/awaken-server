...
public class TradePairInfoIndex : AwakenEntity<Guid>, IIndexBuild
{
    ...
    [Keyword] public Guid Token0Id { get; set; }
    [Keyword] public Guid Token1Id { get; set; }
    [Keyword] public double FeeRate { get; set; }
    [Keyword] public bool IsTokenReversed { get; set; }
}