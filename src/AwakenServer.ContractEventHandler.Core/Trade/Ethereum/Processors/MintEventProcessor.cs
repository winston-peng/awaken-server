...
{
    public class MintEventProcessor : EthereumEthereumEventProcessorBase<MintEventDto>
    {
        ...
        public MintEventProcessor(ITokenAppService tokenAppService, IChainAppService chainAppService,
        ...
        protected override async Task HandleEventAsync(MintEventDto eventDetailsDto,
