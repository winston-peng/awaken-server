...
{
    public class GeneralClaimRevenueProcessor : AElfEventProcessorBase<ClaimRevenue>
    {
        ...
        public GeneralClaimRevenueProcessor(IRepository<FarmRecord> recordRepository,
