...
{
    public class ReservesReducedProcessor : EthereumEthereumEventProcessorBase<ReservesReduced>
    {
        ...
        protected override async Task HandleEventAsync(ReservesReduced eventDetailsEto,
